...
def makeSkinnyJwt(verticalType, classId, objectId, Globalname, Globalmrn, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globalhospitaladdress, Globallocation, Globalservice):
  ...
  try:
    # get class definition and object definition
    classResourcePayload, objectResourcePayload = getClassAndObjectDefinitions(verticalType, classId, objectId, classResourcePayload, objectResourcePayload, Globalname, Globalmrn, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globalhospitaladdress, Globallocation, Globalservice)
...
#
#############################
def getClassAndObjectDefinitions(verticalType, classId, objectId, classResourcePayload, objectResourcePayload, Globalname, Globalmrn, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globalhospitaladdress, Globallocation, Globalservice):
  # get class definition and object definition
  if verticalType == VerticalType.FLIGHT:
    ...
    classResourcePayload = resourceDefinitions.makeEventTicketClassResource(classId, Globalname, Globalmrn ,Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globalhospitaladdress, Globallocation, Globalservice)
    objectResourcePayload = resourceDefinitions.makeEventTicketObjectResource(classId, objectId, Globalname, Globalmrn ,Globaldate, Globaldoctor, Globalhospital, Globallocation, Globalservice)
