...
def demoSkinnyJwt(verticalType, classId, objectId):
  ...
  skinnyJwt = services.makeSkinnyJwt(verticalType, classId, objectId, Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice)
