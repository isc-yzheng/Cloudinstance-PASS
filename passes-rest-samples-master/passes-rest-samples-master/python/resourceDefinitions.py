...
def makeOfferClassResource(classId, Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice):
...
def makeOfferObjectResource(classId, objectId):
  ...
  payload = {
    ...
    ,"barcode": {
      ...
      ,"value": "1234abc"
      ,"alternateText": "Please check below for appointment details"
    }
    ,"validTimeInterval": {
