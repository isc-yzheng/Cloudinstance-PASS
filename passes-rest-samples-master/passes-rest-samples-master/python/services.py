...
def makeSkinnyJwt(verticalType, classId, objectId,  Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice):
  ...
  try:
    # get class definition and object definition
    classResourcePayload, objectResourcePayload = getClassAndObjectDefinitions(verticalType, classId, objectId, classResourcePayload, objectResourcePayload, Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice)
...
#
#############################
def getClassAndObjectDefinitions(verticalType, classId, objectId, classResourcePayload, objectResourcePayload,  Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice):
  # get class definition and object definition
  if verticalType == VerticalType.FLIGHT:
    ...
    classResourcePayload = resourceDefinitions.makeOfferClassResource(classId, Globalname, Globaldate, Globaldoctor, Globalhospital, Globalhospitalphone, Globallocation, Globalservice)
